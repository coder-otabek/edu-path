...
urlpatterns = [
    ...
    path('standalone/<slug:slug>/test/',              views.grant_test_view,         name='grant_test'),
    path('standalone/<slug:slug>/test/submit/',       views.grant_test_submit,       name='grant_test_submit'),
